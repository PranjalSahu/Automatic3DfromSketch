...
#define HARRIS_THRESH 70              // threshold for choosing the corner points using harris
#define MERGE_POINT_THRESH 2.0        // threshold for merging points when
#define PERPENDICULAR_THRESH 4
#define POINT_PAIR_LYING_THRESH 0.99
...
public:
    ...
    int pointliecount(std::vector<i2tuple> points_vector);
